    ...
    def execute(
        ...
        try:
            ...
            if len(anomalies_df) > 0:
                try:
                    from layer3_agents.Prescriptive_Agent.email_notification_agent import trigger_email_if_anomalies
                    email_result = trigger_email_if_anomalies()
                    logger.info(f"Email notification: {email_result['message']}")
